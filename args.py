...
# DATASETNAME = "MSRS_240_320"
DATASETNAME_VS = "small-HDO-X150" # HDO | KAIST | M3SVD
...
def parse_args(timestamp_date, timestamp_time):
    ...
    if system_name == "Windows":
        ...
        parser.add_argument("--test_dataset_path_VS", type=str, default=r"F:\DATASETS\IVIF\test_data") #F:\PythonProject\IVIF\test_data_M3SVD | F:/DATASETS/IVIF/test_data/
        ...
        parser.add_argument("--indices", type=int, default=10)  # 子数据集缩小倍数
        parser.add_argument("--test_video_path", type=str, default=r"F:/DATASETS/IVIF/video_test/")

    elif system_name == "Linux":
        print("Linux")
        parser.add_argument('--batch_size', type=int, default=4) # 128 |  64 | 32 | 16
        ...
        parser.add_argument("--indices", type=int, default=1)  # 子数据集缩小倍数
